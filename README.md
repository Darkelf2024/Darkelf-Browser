...
Darkelf Post-Quantum Editions - Source Code Released = Darkelf will remain as a Pythoon Script .py file until further notice. Head to Darkelf Post Quantum Repository. 
